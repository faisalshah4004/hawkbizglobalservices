    ...
    <>
      ...
      <section className="bg-navy py-20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-slate-400 mb-8">Tell us your requirements and we'll compare plans from leading UAE insurers to find the best coverage at the right price.</p>
